...
class _HomepageState extends State<Homepage> with TickerProviderStateMixin {
  ...
  String getWeatherIcon(int? code) {
    if (code != null) {
      ...
      // Handle the case when code is null (provide a default image or path)
                          ...
                          children: [
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        Text("High", style: TextStyle(
                                            ...
                                            fontSize: 20),),
                                        SizedBox(height: 3,),
                                        Text("${state.weather.tempMax}", style: TextStyle(fontSize: 15,
                                            fontWeight: FontWeight.w700,
                                            color: Colors.white),),
                                        SizedBox(height: 3,),
                                      ],
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        Text("Low", style: TextStyle(
                                            ...
                                            fontSize: 20),),
                                        SizedBox(height: 3,),
                                        Text("${state.weather.tempMin}", style: TextStyle(fontSize: 15,
                                            fontWeight: FontWeight.w700,
                                            color: Colors.white),),
                            ...
                            Row(
                              ...
                              children: [
                                Row(
                                  children: [
                                    Image.asset('assets/img/wind.png', scale: 20,),
                                    SizedBox(width: 4,),
                                    Column(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        Text("Wind", style: TextStyle(
                                            ...
                                            fontSize: 20),),
                                        SizedBox(height: 3,),
                                        Text("${state.weather.windSpeed}", style: TextStyle(fontSize: 15,
                                            fontWeight: FontWeight.w700,
                                            color: Colors.white),),
                                        SizedBox(height: 3,),
                                      ],
                                ...
                                Row(
                                  children: [
                                    Image.asset('assets/img/Rain.png', scale: 15,),
                                    SizedBox(width: 4,),
                                    Column(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        Text("Rain", style: TextStyle(
                                            ...
                                            fontSize: 20),),
                                        SizedBox(height: 3,),
                                        Text('${state.weather.snowLastHour}', style: TextStyle(
                                            fontWeight: FontWeight.w700,
                                            color: Colors.white),)
                                      ],
                                    )
